...
This image of [Puppet Check](https://github.com/mschuchard/puppet-check) is based on the `ruby:3.3-alpine` image. It will contain the latest versions of Alpine Linux and Ruby 3.3.x at the time of build. It will also contain the latest version of its dependencies at time of build. This includes Puppet, Facter, Hiera, Puppet-Lint, Rubocop (including performance and rspec plugins), and Reek.
